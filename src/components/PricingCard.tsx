        ...
        <div className="p-4 md:p-6 lg:p-8 relative z-10">
          ...
          {canCalculatePrice ? (
            <>
              ...
              {/* CTA Button */}
              <Button 
                className="w-full bg-gradient-to-r from-mlbb-purple to-mlbb-darkpurple hover:opacity-90 text-white py-4 md:py-6 text-sm md:text-lg transition-all duration-300"
              >
                Proceed to Checkout
              </Button>
            </>
