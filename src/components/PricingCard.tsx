...
const PricingCard: React.FC<PricingCardProps> = ({
  ...
  return <div className={`transition-all duration-700 transform ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-20"}`}>
      <div className="glass-panel overflow-hidden relative">
        ...
        {/* Card content */}
        <div className="p-11 md:p-6 lg:p-8 relative z-10 px-[32px] py-[25px]">
          ...
          {canCalculatePrice ? <>
              ...
              {/* CTA Button */}
              <Button className="w-full bg-gradient-to-r from-mlbb-purple to-mlbb-darkpurple hover:opacity-90 text-white py-4 md:py-6 text-sm md:text-lg transition-all duration-300">
                Proceed to Checkout
              </Button>
